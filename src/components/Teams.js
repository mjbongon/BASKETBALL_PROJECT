...
const Teams = () => {
  // Updated dummy data with team names and logo URLs
  const divisions = [
    { 
      name: 'Atlantic', 
      teams: [
            ...
            <div key={division.name} className="division">
              ...
              <div className="teams">
                {division.teams.map((team) => (
                  <Link 
                    key={team.name} 
                    to={`/Teams/${team.name.replace(/\s+/g, '-').toLowerCase()}`} // Link to team details page
                    className="team"
                  >
            ...
            <div key={division.name} className="division">
              ...
              <div className="teams">
                {division.teams.map((team) => (
                  <Link 
                  key={team.name} 
                  to={`/Teams/${team.name.replace(/\s+/g, '-').toLowerCase()}`} // Link to the team's detail page
                  className="team"
                >
                  <img src={team.logoUrl} alt={team.name} className="team-logo" />
                  <span className="team-name">{team.name}</span>
